...
import xyz.nifeather.fexp.misc.ExecutionErrorException;
...
public class TranslateManager
{
    ...
    private void init()
    {
        ...
        var messagesDirectory = new File(FeatherExperience.getInstance().getDataFolder(), "messages");
    ...
    public MessageStore<FeatherExperience> asFrameworkMessageStore()
    {
        return new FrameworkMessageStoreBinding(this);
    }

    public static class FrameworkMessageStoreBinding extends MessageStore<FeatherExperience>
    {
